...
const SEED_EVENTS: Event[] = [
  ...
  { id: 'seed-2', date: '2026-07-03', title: '🎉 Sandbar',        category: 'social',   photoQuery: 'Canggu Bali beach bar sunset cocktail',         coords: [-8.638, 115.116] },
  { id: 'seed-3', date: '2026-07-04', title: '🎉 Finns',          category: 'social',   photoQuery: 'Canggu Bali surf beach club pool party',        coords: [-8.644, 115.131] },
  { id: 'seed-4', date: '2026-07-11', title: '🎉 Atlas',          category: 'social',   photoQuery: 'Bali beach club sunset pool canggu',           coords: [-8.652, 115.134] },
            ...
            {([
              ...
              <input
                ...
                style={{
                  ...
                  color: field.color, fontSize: '1rem', marginBottom: 10,
                }}
              />
            ))}
